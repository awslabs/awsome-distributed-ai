...
echo "   aws ssm send-command --instance-ids $LOGIN_INSTANCE --region $REGION --profile $PROFILE --document-name 'AWS-RunShellScript' --parameters 'commands=[\"ls -la /opt/aws-parallelcluster-monitoring/\"]'"
echo ""
