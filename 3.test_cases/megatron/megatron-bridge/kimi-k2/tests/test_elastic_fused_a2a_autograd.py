...
def main() -> None:
    ...
    assert isinstance(sync_handle._mcore_elastic_buffer, deep_ep.ElasticBuffer)
    assert isinstance(async_handle._mcore_elastic_buffer, deep_ep.ElasticBuffer)
            ...
            + json.dumps(
                {
                    ...
                    "elastic_buffer_type": type(
                        sync_handle._mcore_elastic_buffer
                    ).__name__,
