...
#
# Phase 2 - Arm C/D: GRPO on math data using veRL
...
CKPT_DIR="${CKPT_DIR:-/fsx/qwen-grpo/checkpoints/math/grpo}"
REWARD_PATH="${REWARD_PATH:-/workspace/experiments/src/math_reward.py}"
...
# Experiment naming
EXP_NAME="${EXP_NAME:-phase2-grpo-math}"

echo "============================================"
echo "Phase 2 - GRPO (Math)"
echo "============================================"
...
echo "============================================"
echo "GRPO (Math) job submitted to Ray: ${EXP_NAME}"
