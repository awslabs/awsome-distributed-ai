...
| [`deepep-v2-efa`](./deepep-v2-efa) | EKS / Slurm | Mixture-of-Experts (`Qwen3-30B-A3B-FP8`) with DeepEP-V2 expert-parallel all-to-all over EFA via the NCCL-GIN CPU-proxy, on `p5en.48xlarge`. Eager + non-eager, DP16/EP16 and DP32/EP32. |
