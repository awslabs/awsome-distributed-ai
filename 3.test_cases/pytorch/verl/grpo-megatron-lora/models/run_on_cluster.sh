...
usage() {
    cat <<'USAGE'
Usage: ./models/run_on_cluster.sh <script>

Dispatches a model download script to the fsx-utils pod for execution.
...
Examples:
  ...
  ./models/run_on_cluster.sh models/download_qwen25_72b.sh
  ./models/run_on_cluster.sh models/download_qwen3_235b.sh
