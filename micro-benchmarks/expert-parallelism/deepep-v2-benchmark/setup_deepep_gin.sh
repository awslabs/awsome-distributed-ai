...
print_completion_notes() {
    ...
    log "  export NCCL_NET_PLUGIN=/opt/amazon/ofi-nccl/lib/libnccl-net-ofi.so   # from the EFA installer (>= 1.50) run in this container"
    log "  export NCCL_GIN_PLUGIN=/opt/amazon/ofi-nccl/lib/libnccl-net-ofi.so"
    log ""
