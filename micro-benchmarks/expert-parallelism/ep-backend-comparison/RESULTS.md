...
[`RESULTS-p5.md`](RESULTS-p5.md). For the newer **B200** direct comparison that adds DeepEP V2
over NCCL GIN EFA-GDA, see [`RESULTS-b200.md`](RESULTS-b200.md). Hardware generations and
campaigns are reported separately.
