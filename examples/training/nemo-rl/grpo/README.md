...
Use any math problem dataset with `prompt` and `answer` fields in JSONL
format (the evaluation script [`eval_nemotron_goldilocks.py`](./eval_nemotron_goldilocks.py)
shows the expected schema).
