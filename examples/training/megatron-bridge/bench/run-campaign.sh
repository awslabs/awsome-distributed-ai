...
$K cp "${REPO_ROOT}/examples/training/megatron-bridge/dsv3/benchmarks/bench_dsv3_pretrain.py" ${UTIL}:/fsx/kimi-k2/bench_dsv3_pretrain.py
$K cp "${REPO_ROOT}/examples/training/megatron-bridge/kimi-k2/benchmarks/bench_kimi_k2_pretrain.py" ${UTIL}:/fsx/kimi-k2/bench_kimi_k2_pretrain.py
