...
Stand up a HyperPod-EKS cluster with the official [Terraform modules](https://github.com/awslabs/awsome-distributed-ai/tree/main/architectures/sagemaker-hyperpod-eks/terraform-modules).
...
(`examples/use-cases/cosmos3/`). If you have not already, create `env_vars` from the
