...
[`nvidia/Cosmos-Guardrail1`](https://huggingface.co/nvidia/Cosmos-Guardrail1)). See [`architectures/`](../../../architectures/) for
...
- EKS cluster architectures — [`architectures/amazon-eks`](../../../architectures/amazon-eks)
- SageMaker HyperPod EKS architectures — [`architectures/sagemaker-hyperpod-eks`](../../../architectures/sagemaker-hyperpod-eks)
