...
[`architectures/`](../../../../architectures/) for reference cluster setup (the
[EKS](../../../../architectures/amazon-eks/) and
[SageMaker HyperPod EKS](../../../../architectures/sagemaker-hyperpod-eks/) modules).
...
expands. Run these commands from the test-case root (`examples/use-cases/cosmos3/`).
