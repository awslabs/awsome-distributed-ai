...
[`architectures`](../../../../../architectures), the
...
`examples/use-cases/openvla-oft`, the directory that holds the
...
cd examples/use-cases/openvla-oft
...
cd awsome-distributed-ai/examples/use-cases/openvla-oft/kubernetes/libero
```
...
root (`examples/use-cases/openvla-oft`, the directory that holds the
...
[`examples/training/nvrx/Dockerfile`](../../../../training/nvrx/Dockerfile):
